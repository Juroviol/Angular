...
|polyfills.ts|Esse arquivo importa diversos linhas de código que fazem a aplicação compatível para diferentes navegadores. Os códigos escritos em Angular em sua maioria em ES6 o qual não é compatível com o IE ou firefox e necessita de alguns ajustes de ambiente. Angular é construído nos mais recentes padrões de desenvolvimento web. Atingir uma grande quantidade de navegadores é desafiador pois eles não suportam todas as funcionalidades dos navegadores mais modernos.|
